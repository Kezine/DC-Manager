...
/* ---- types d'équipement (icône SVG viewBox 24, currentColor) ----
   IDs en ANGLAIS (identifiants persistés). Un type stocké NON reconnu (ancien id français, id supprimé…) est
   RÉSOLU sur `other` à l'affichage (cf. EquipmentTypes.resolveId) — pas de migration de données ni de rétro-compat.

   NOTE `system` : marque les types au **traitement SPÉCIFIQUE dans l'app** (pilotage fin), donc **non supprimables**
   si une gestion des types devenait éditable. Aujourd'hui ce sont les types que le code câble en dur :
     - `patch_panel` : édition de brins de faisceau (PortEditorControls.isPatch, réseau déduit) ;
     - `pdu` / `switchboard` : distribution électrique (départs, `pdu_max_a`, racine d'alim — cf. PowerAnalysis) ;
     - `switch` : cœur réseau (ports/réseaux/PoE) piloté finement.
   Les autres types sont de l'INVENTAIRE générique (pas de logique dédiée) → librement supprimables (à terme). */
export interface EquipmentTypeDef { id: string; labelKey: string; icon: string; system?: boolean; }
export const EQUIPMENT_TYPES: EquipmentTypeDef[] = [
  { id: "switch",     labelKey: "domain.equipmentType.switch",     system: true, icon: `<rect x="2" y="6" width="20" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="2"/><path d="M7 10h7l-2-2m2 2-2 2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 14h-7l2-2m-2 2 2 2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>` },
  { id: "server",     labelKey: "domain.equipmentType.server",     icon: `<rect x="3" y="4" width="18" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="2"/><rect x="3" y="13" width="18" height="7" rx="1.5" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="7" cy="7.5" r="1.1" fill="currentColor"/><circle cx="7" cy="16.5" r="1.1" fill="currentColor"/>` },
  { id: "enclosure",  labelKey: "domain.equipmentType.enclosure",  icon: `<path d="M12 3l8 4.5v9L12 21l-8-4.5v-9L12 3z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M4 7.5l8 4.5 8-4.5M12 12v9" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>` },
  ...
  { id: "camera",     labelKey: "domain.equipmentType.camera",     icon: `<rect x="2.5" y="8" width="12.5" height="9" rx="2" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="8.75" cy="12.5" r="2.6" fill="none" stroke="currentColor" stroke-width="2"/><path d="M15 11l5.5-2.75v8.5L15 14z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>` },
  { id: "patch_panel",labelKey: "domain.equipmentType.patch_panel",system: true, icon: `<rect x="2" y="8" width="20" height="8" rx="1.5" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="6" cy="12" r="1" fill="currentColor"/><circle cx="9.5" cy="12" r="1" fill="currentColor"/><circle cx="13" cy="12" r="1" fill="currentColor"/><circle cx="16.5" cy="12" r="1" fill="currentColor"/><circle cx="20" cy="12" r="1" fill="currentColor"/>` },
  { id: "pdu",        labelKey: "domain.equipmentType.pdu",        system: true, icon: `<rect x="8" y="2" width="8" height="20" rx="1.5" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="6" r="1.1" fill="currentColor"/><circle cx="12" cy="10" r="1.1" fill="currentColor"/><circle cx="12" cy="14" r="1.1" fill="currentColor"/><circle cx="12" cy="18" r="1.1" fill="currentColor"/>` },
  { id: "switchboard",labelKey: "domain.equipmentType.switchboard",system: true, icon: `<rect x="3" y="3" width="18" height="18" rx="2" fill="none" stroke="currentColor" stroke-width="2"/><rect x="6.5" y="6" width="3" height="5" rx="0.6" fill="none" stroke="currentColor" stroke-width="1.6"/><rect x="10.5" y="6" width="3" height="5" rx="0.6" fill="none" stroke="currentColor" stroke-width="1.6"/><rect x="14.5" y="6" width="3" height="5" rx="0.6" fill="none" stroke="currentColor" stroke-width="1.6"/><path d="M6 15h12" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/><path d="M6 18h8" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>` },
  { id: "ups",        labelKey: "domain.equipmentType.ups",        icon: `<rect x="2.5" y="7" width="15" height="10" rx="1.5" fill="none" stroke="currentColor" stroke-width="2"/><rect x="18" y="10" width="2.5" height="4" rx="0.5" fill="currentColor"/><path d="M11 9l-3 4.5h2.3l-1 3.5 3.7-5.5H10.7L12 9z" fill="currentColor"/>` },
  { id: "other",      labelKey: "domain.equipmentType.other",      icon: `<rect x="3" y="6" width="18" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="8" cy="12" r="1.1" fill="currentColor"/><circle cx="12" cy="12" r="1.1" fill="currentColor"/><circle cx="16" cy="12" r="1.1" fill="currentColor"/>` },
];
export const EQUIPMENT_TYPE_DEFAULT = "switch";
/** Type de repli quand un id stocké n'est pas (ou plus) reconnu (cf. EquipmentTypes.resolveId). */
export const EQUIPMENT_TYPE_FALLBACK = "other";
