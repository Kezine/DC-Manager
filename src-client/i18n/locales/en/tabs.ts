/* ============================================================================
   Domaine `tabs` — ANGLAIS. Calque EXACT de `../fr/tabs.ts`. Agrégé par `../en.ts`.
   « Netmap » reste « Netmap » (nom de fonctionnalité, cf. fr/tabs.ts). Termes du
   domaine conservés : IPAM, DHCP, VLAN, Proxmox, QEMU, LXC, PKI, X.509/SSH,
   IndexedDB, IPv4 CIDR, U (unités de baie). */
export const tabs = {
  equipements: {
    label: "Equipment",
