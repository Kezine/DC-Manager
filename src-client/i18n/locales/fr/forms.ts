...
export const forms = {
  ...
  port: {
    ...
    poeInject: "Injection PoE",
    poeDraw: "Consommation PoE",
    poeEnabledHint: "Active l'injection (PSE) / la consommation (PD) sur ce port. L'éclair d'énergie du câble n'apparaît que si les deux côtés sont actifs.",
