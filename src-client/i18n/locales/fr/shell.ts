...
export const shell = {
  ...
  settings: {
    ...
    themeDark: "Sombre",
    themeNote: "Auto suit le réglage clair/sombre du système et le suit AUSSI s'il change en cours de session. Choisir Clair ou Sombre fige le thème, quel que soit le système.",
  ...
  user: {
    ...
    infoTitle: "Session utilisateur",
    fieldLogin: "Identifiant",
    fieldEmail: "E-mail",
    status: "Statut",
    rights: "Droits d'accès",
    rightsFull: "Accès complet",
    rightsNone: "Aucun droit d'accès",
    domain: {
      dc_equipment: "Équipements",
      dc_cabling: "Câblage",
      dc_rack: "Baies",
      dc_site: "Sites et salles",
      dc_ip: "Adressage IP",
      dc_app: "Applications",
      dc_contact: "Contacts",
      dc_attachment: "Pièces jointes",
