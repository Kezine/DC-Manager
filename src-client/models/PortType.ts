...
export class PortType extends Entity {
  ...
  /** "data" | "power". */
  kind: string;
  /** DUPLEX : une connexion de ce connecteur consomme une PAIRE de brins (Tx/Rx) au lieu d'un seul.
      Pilote le nombre de brins piochés par un port de patch (2 si duplex, 1 sinon) — cf. Port.strand_a/strand_b.
      Ex. « LC duplex » = true. Défaut false (connecteur simplex / non fibre). */
  duplex: boolean;
