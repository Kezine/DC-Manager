...
export class Waypoint extends Entity {
  ...
  spread: boolean;
  /** Positionnement VERROUILLÉ : empêche déplacement / retrait (salle · étage) DEPUIS LES VUES 2D/3D
      — cf. PlacementLock. Le formulaire reste l'échappatoire (principe n°10). Défaut : libre. */
  locked: boolean;
  /** OOB : étage ("" = 0). */
  floor: string;
