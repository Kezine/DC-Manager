...
/* =============================================================================
   ...
   `.dc-search-tag`) sont LES SIENS — aucune vue n'en possède de variante. GÉNÉRIQUE :
   la source des résultats (`fetch`) et l'effet du clic (`onPick`) sont INJECTÉS — le
   composant ne connaît ni le réseau, ni la vue qui l'emploie (principe n°2 : couplage
   par paramètres, pas par import). La vue Datacenter, elle, n'a plus de champ de
   recherche propre : la localisation passe par la recherche GLOBALE (Ctrl+K).
