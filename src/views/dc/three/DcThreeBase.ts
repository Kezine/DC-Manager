...
export interface DcThreeOptions {
  ...
  hiddenDoors: Set<string>;   // baies dont les PORTES sont masquées (par baie) — bascule de visibilité de la couche "door"
