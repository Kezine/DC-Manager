...
class EmitStaticAssetsPlugin {
  constructor(files) { this.files = files; }   // [{ from: "src-client/pwa/sw.js", to: "sw.js" }]
  apply(compiler) {
  ...
  return {
    ...
    plugins: [
      ...
      new EmitStaticAssetsPlugin([
        { from: "src-client/pwa/manifest.webmanifest", to: "manifest.webmanifest" },
        { from: "src-client/pwa/sw.js", to: "sw.js" },
        { from: "src-client/pwa/icon-192.png", to: "icons/icon-192.png" },
        { from: "src-client/pwa/icon-512.png", to: "icons/icon-512.png" },
        { from: "src-client/pwa/icon-maskable-512.png", to: "icons/icon-maskable-512.png" },
      ]),
    ],
    devServer: {
